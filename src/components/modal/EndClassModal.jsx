        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none md:p-16 p-8">
            ...
            <div className="flex items-center justify-start p-6 border-t border-solid border-blueGray-200 rounded-b">
              <button
                className=" px-10 py-2 text-sm font-medium md:text-lg bg-red-400 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-red-400 mr-1 mb-1 "
                type="button"
              ...
              <button
                className=" text-gray-500 px-5 py-2 text-sm font-medium md:text-lg rounded-md focus:outline-none focus:ring-2 focus:ring-red-400 mb-1"
                type="button"
                onClick={() => setShowModal(false)}
              >
                Cancel
